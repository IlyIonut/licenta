    ...
    return(
      ...
      style={{ backgroundImage: `url(${profileImage})`}}>
            ...
            <div className='flex-column justify-around items-end content-end w-1/3 text-white align-bottom md:w-full'>
                <a href={gitHubLink} target="_blank" rel="noreferrer"><AiFillGithub className='w-8 h-8 bg-amber-600 rounded-full cursor-pointer' aria-label='Github'/></a>
                <a href={linkedinLink} target="_blank" rel="noreferrer"><AiFillLinkedin className='w-8 h-8 bg-amber-600 rounded-full cursor-pointer' aria-label='Linkedin'/></a>
                <a href={instagramLink} target="_blank" rel="noreferrer"><AiFillInstagram className='w-8 h-8 bg-amber-600 rounded-full cursor-pointer' aria-label='Instagram' /></a>
            </div>
