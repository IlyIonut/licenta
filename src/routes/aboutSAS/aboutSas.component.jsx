...
const AboutSas = () => {
    return(
        ...
        <AboutContainer className='flex flex-wrap items-start justify-between w-5/6 my-10 overflow-hidden bg-white dark:bg-dark-500 lg: rounded-2xl shadow-custom-light dark:shadow-custom-dark'>
                <div className="flex flex-col items-center w-3/5 h-auto mt-2 mb-5 ml-6">
                    <h3 className="p-5 mb-5 text-4xl font-semibold" >Cine suntem și ce facem?</h3>
        ...
        <div className="flex flex-wrap justify-between mt-5 mb-10">
            <AboutContainer className='flex flex-col items-center justify-center mx-8 overflow-hidden bg-white w-80 dark:bg-dark-500 lg: rounded-2xl shadow-custom-light dark:shadow-custom-dark'>
